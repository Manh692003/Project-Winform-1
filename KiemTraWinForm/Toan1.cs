...
{
    public partial class Toan1 : Form
    {
        ...
        private void Toan1_Load(object sender, EventArgs e)
        {
        ...
        private void nopbai_Click(object sender, EventArgs e)
        {
            ...
            if (lanthi.RowCount - 1 == 0)
            {
                ...
                KQToan1.DiemThi = diem.ToString();
                KQToan1.ck1 = check1.Text;
                KQToan1.ck2 = check2.Text;
                KQToan1.ck3 = check3.Text;
                KQToan1.ck4 = check4.Text;
                KQToan1.ck5 = check5.Text;
                KQToan1.ck6 = check6.Text;
                KQToan1.ck7 = check7.Text;
                KQToan1.ck8 = check8.Text;
                KQToan1.ck9 = check9.Text;
                KQToan1.ck10 = check10.Text;

                string query = "insert into KetQua values ('" + lbtl.Text + "', '" + msv.Text + "', '" + mon.Text + "', " + diem + ")";
                modify.Connand(query);

                KQToan1 kQ = new KQToan1();
                kQ.ShowDialog();
            }
            else
            {
