...
namespace KiemTraWinForm
{
    public partial class Anh1 : Form
    {
        ...
        private void Anh1_Load(object sender, EventArgs e)
        {
        ...
        private void nopbai_Click_1(object sender, EventArgs e)
        {
            if (tinhgio.Enabled)
            {
                tinhgio.Stop();
            ...
            if (lanthi.RowCount - 1 == 0)
            {
                ...
                KQAnh1.DiemThi = diem.ToString();
                KQAnh1.ck1 = check1.Text;
                KQAnh1.ck2 = check2.Text;
                KQAnh1.ck3 = check3.Text;
                KQAnh1.ck4 = check4.Text;
                KQAnh1.ck5 = check5.Text;
                KQAnh1.ck6 = check6.Text;
                KQAnh1.ck7 = check7.Text;
                KQAnh1.ck8 = check8.Text;
                KQAnh1.ck9 = check9.Text;
                KQAnh1.ck10 = check10.Text;

                string query = "insert into KetQua values ('" + tenlop.Text + "', '" + msv.Text + "', '" + mon.Text + "', " + diem + ")";
                modify.Connand(query);

                KQAnh1 kq = new KQAnh1();
                kq.ShowDialog();
            }
            else
            {
