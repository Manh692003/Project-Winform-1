...
namespace KiemTraWinForm
{
    public partial class Anh2 : Form
    {
        ...
        private void Anh2_Load(object sender, EventArgs e)
        {
        ...
        private void nopbai_Click(object sender, EventArgs e)
        {
            ...
            if (lanthi.RowCount - 1 == 0)
            {
                ...
                KQAnh2.DiemThi = diem.ToString();
                KQAnh2.ck1 = check1.Text;
                KQAnh2.ck2 = check2.Text;
                KQAnh2.ck3 = check3.Text;
                KQAnh2.ck4 = check4.Text;
                KQAnh2.ck5 = check5.Text;
                KQAnh2.ck6 = check6.Text;
                KQAnh2.ck7 = check7.Text;
                KQAnh2.ck8 = check8.Text;
                KQAnh2.ck9 = check9.Text;
                KQAnh2.ck10 = check10.Text;

                string query = "insert into KetQua values ('" + tenlop.Text + "', '" + msv.Text + "', '" + mon.Text + "', " + diem + ")";
                modify.Connand(query);

                KQAnh2 kq = new KQAnh2();
                kq.ShowDialog();
            }
            else
            {
